...
wget https://github.com/JordanSamhi/Tools/raw/master/dare.zip &> /dev/null
check_return $? "Something went wrong while downloading Dare." "Dare downloaded."

unzip dare.zip &> /dev/null
check_return $? "Something went wrong while unzipping Dare." "Dare unzipped."
rm dare.zip
